platform "el-7-x86_64" do |plat|
  ...
  plat.provision_with "rpm --import http://nightlies.puppetlabs.com/07BB6C57"
  ...
  plat.provision_with "yum install --assumeyes autoconf automake gcc createrepo make rpmdevtools rpm-libs yum-utils rpm-sign libtool autogen"
